...
10. **Visual QA** — if `GOOGLE_API_KEY` is set, run automated visual QA. If not set, rely on step 9's manual screenshot inspection (Claude can read PNG files directly). See `visual-qa.md` for details.
